...
import static com.efimchik.ifmo.web.mvc.Utils.readTestResourceFile;
import static com.efimchik.ifmo.web.mvc.Utils.testCaseRoutine;
...
public class MvcTests {
    ...
    public void testAll() throws Exception {
        ...
        testCaseRoutine(testCaseFile, testCase -> {
            final MvcResult res = mockMvc.perform(get("/employees"))
                    .andDo(log())
                    .andExpect(
                            status().isOk())
                    .andExpect(
                            content().json(readTestResourceFile(testCase), false))
                    .andReturn();
    ...
    private void testByIdFullChain(final Long id) throws Exception {
        ...
        testCaseRoutine(testCaseFileFull, testCase -> {
