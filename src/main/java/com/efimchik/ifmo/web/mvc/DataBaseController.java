...
public class DataBaseController {
    ...
    private List<Employee> employeeList(ResultSet resultSet) {
        List<Employee> employeeList = getEmployeeList(resultSet, true);
        return employeeList;
    }

    private List<Employee> employeeListWithShortChain(ResultSet resultSet) {
        List<Employee> employeeList = getEmployeeList(resultSet, false);
        return employeeList;
    }
    ...
    private ResultSet getResultSet(String SQLString) {
        try {
            ...
            ResultSet newResultSet = statement.executeQuery(SQLString);
