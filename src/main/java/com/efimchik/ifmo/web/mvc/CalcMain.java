...
public class CalcMain {
    ...
    private static final Pattern[] PATTERNS_SUB = new Pattern[] {
    ...
    public CalcMain(Equation equation) {
    ...
    public ResponseEntity<String> getResult() {
        ...
        for (Matcher matcher = LETTER.matcher(eq); matcher.find(); matcher = LETTER.matcher(eq)) {
        ...
        try {
            for (Matcher matcher = IN_BRACKETS.matcher(eq); matcher.find(); matcher = IN_BRACKETS.matcher(eq)) {
                final int start = matcher.start();
                final int end = matcher.end();
    ...
    private String calc(String equation) {
        ...
        for (Pattern subeqRegex : PATTERNS_SUB) {
    ...
    private Long calcSubeq(String subeq) {
        final Matcher matcher = OPERATION.matcher(subeq);
